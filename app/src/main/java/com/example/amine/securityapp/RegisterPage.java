...
public class RegisterPage extends AppCompatActivity {
    ...
    TextView skip_login, go_to_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        go_to_main = (TextView) findViewById(R.id.go_to_main);
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText(RegisterPage.this,"Please Fill All The Required Fields.", Toast.LENGTH_LONG).show();
    ...
    public void CheckFinalResult(){
        ...
        if(F_Result.equalsIgnoreCase("Email Found"))
        {
            ...
            Toast.makeText(RegisterPage.this,"Email Already Exists",Toast.LENGTH_LONG).show();
