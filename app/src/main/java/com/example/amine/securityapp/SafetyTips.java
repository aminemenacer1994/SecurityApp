...
public class SafetyTips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_safety_tips2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.home:
                ...
                SafetyTips.this.startActivity(intent);
            ...
            case R.id.flashlight:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SafetyTips.this);
            ...
            case R.id.info:
                ...
                intent = new Intent(SafetyTips.this, Info.class);
                SafetyTips.this.startActivity(intent);
            ...
            case R.id.tips:
                ...
                intent = new Intent(SafetyTips.this, SafetyTips.class);
                SafetyTips.this.startActivity(intent);
            ...
            case R.id.exit:
                ...
                builder = new AlertDialog.Builder(SafetyTips.this);
